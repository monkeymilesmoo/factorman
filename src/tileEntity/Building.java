...
public class Building extends TileEntity{
	...
	public static void loadBuildingImages(){
		...
		try{
			...
			buildingImages.put("assembling-machine-1", new EntityImage("building/assembling-machine-1/assembling-machine-1", 32, 1, 3, 3, 12, 18, "assembling-machine-1"));
			buildingImages.put("assembling-machine-1-shadow", new EntityImage("building/assembling-machine-1/assembling-machine-1-shadow", 32, 1, 3, 3, 4, 13, null));
			buildingImages.put("steel-chest", new EntityImage("building/steel-chest/steel-chest", 1, 1, 1, 1, 0, 10, "steel-chest"));
